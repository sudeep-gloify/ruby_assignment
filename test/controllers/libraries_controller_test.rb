...
class LibrariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create library" do
    assert_difference('Library.count') do
      post libraries_url, params: { library: { closing_time: @library.closing_time, name: @library.name, opening_time: @library.opening_time } }
    end
  ...
  test "should update library" do
    patch library_url(@library), params: { library: { closing_time: @library.closing_time, name: @library.name, opening_time: @library.opening_time } }
